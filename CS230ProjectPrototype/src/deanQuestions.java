 ...
 * @author Owner
 */
public class deanQuestions extends javax.swing.JFrame {

    /**
     * Creates new form deanQuestions
     */
    public deanQuestions() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deanQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deanQuestions().setVisible(true);
            }
        });
    }
